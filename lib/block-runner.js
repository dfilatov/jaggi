...
module.exports = inherit({
        ...
        if(!this._isRunning) {
            ...
            try {
                ...
                if(typeof this._blockRes === 'undefined') {
                    ...
                    this._blockPromise.fulfill(this._blockRes);
                }
            }
            catch(e) {
            ...
            return (this._blockPromise.isResolved()?
                this._blockPromise :
                Promise.timeout(this._blockPromise,this._meta.timeout))
                    .then(
    ...
    _processFromCache : function() {
        var cacheDesc = this._desc.cache;
        cacheDesc &&
            (this._blockRes = this._params.cacheFactory.create(cacheDesc.type).get(this._buildCacheParams(cacheDesc)));
    },
    ...
    _processToCache : function() {
        ...
        cacheDesc &&
            this._params.cacheFactory.create(cacheDesc.type)
                .set(this._blockRes, this._buildCacheParams(cacheDesc));
    },
